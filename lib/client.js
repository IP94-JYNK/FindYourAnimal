...
const HEADERS = {
  ...
  'Content-Security-Policy': [
    `default-src 'self' ws:`,
    `style-src 'self' https://fonts.googleapis.com https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/css/bootstrap.min.css https://use.fontawesome.com/releases/v5.15.3/css/svg-with-js.css`,
    `font-src 'self' https://fonts.gstatic.com`,
    `script-src 'self' https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js https://use.fontawesome.com/releases/v5.15.3/js/all.js`,
  ].join('; '),
};
